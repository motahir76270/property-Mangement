...
const EditProperty = () => {
  const { selectedList } = useContext(UserContext);
  ...
  return (
    <div className="flex min-h-screen justify-center items-center bg-gray-300 px-3 py-6">
      <form
        className="bg-white w-full p-7 md:w-1/2  md:p-10 rounded-xl shadow-md flex flex-col gap-3"
